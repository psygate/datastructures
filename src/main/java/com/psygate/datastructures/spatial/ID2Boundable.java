...
public interface ID2Boundable {
     ...
     */
    boolean isInside(ID2BoundingBox box);
     ...
     */
    boolean leftOf(double median, Axis2D axis);
     ...
     */
    boolean rightOf(double median, Axis2D axis);
     ...
     */
    ID2BoundingBox merge(ID2BoundingBox box);
}
